      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed inset-0 sm:inset-auto sm:bottom-6 sm:right-6 z-50 sm:w-[380px] md:w-[500px] shadow-2xl sm:rounded-2xl overflow-hidden bg-background border border-border flex flex-col sm:h-[700px]"
          >
            {/* Header */}
